...
'12.02.2020: LR changed name of process from 'sixshutters' to 'shutters'

'par_73: Shutter number (0 ... 5) or shutter family (6 - all minflux shutters, 7 - all shutters) or 10 for aux confocal 
'par_72: Shutter state (0 - Closed, x - Open)
...
EVENT:
  ...
  'Evaluate par_71 and select shutter accordingly
  SelectCase par_73
    ...
    Case 10 'Shutter 7 - AUX confocal at port 24
      If (par_72 = 0) Then
        Digout(24, 0) 'Set TTL value to LOW
      Else
        Digout(24, 1) 'Set TTL value to HIGH
      EndIf
